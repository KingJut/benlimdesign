  	<div class="col col-50">
    	<div class="col-inner-hori">
    	 <h2 class="lb-1 <?php echo get_field('comments_text_size_1', 'option'); ?>"><?php if (get_field('copy_7', 'option')) {echo get_field('copy_7', 'option');} ?></h2>
    	</div>
    </div>
  	<div class="col col-50">
    	<div class="col-inner-hori">
    	...
    	<?php if (get_comments_number() == 0) { ?>
    	 <p class="<?php echo get_field('comments_text_size_1', 'option'); ?> lb-2"><?php if (get_field('copy_9', 'option')) {echo get_field('copy_9', 'option');} ?></p>
    	<?php } ?>
...
<?php include('separator.php'); ?>
  	...
  	<div class="col col-50">
    	<div class="col-inner-hori">
    	 <h2 class="lb-1 <?php echo get_field('comments_text_size_1', 'option'); ?>"><?php if (get_field('copy_8', 'option')) {echo get_field('copy_8', 'option');} ?></h2>
    	</div>
    </div>
  	<div class="col col-50">
    	<div class="col-inner-hori">
