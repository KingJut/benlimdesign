...
if ($layout_style == 'Grid Masonry') {
  ...
  echo '<div class="row-module module row-holder"><div class="row '.$row_item_overlay_text_size.'">';
  // Query Posts from Cat
  $args = array(
	  'cat' => $cat,
	  'posts_per_page' => $number_of_posts
  ...
  echo '<div class="index-module module index-list">';
  // Query Posts from Cat
  $args = array(
	  'cat' => $cat,
	  'posts_per_page' => $number_of_posts
  ...
  if ( have_posts() ) : while ( have_posts() ) : the_post();
    ...
    echo '<div class="grid-module module appender">'; ?>
